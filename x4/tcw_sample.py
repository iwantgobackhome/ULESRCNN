...
def parse_args():
    ...
    parser.add_argument("--ckpt_path", type=str, default="./checkpoint/lesrcnn_x4_477000.pth")
    parser.add_argument("--group", type=int, default=1)
    parser.add_argument("--sample_dir", type=str, default="samples_single_model_urban_x4")
