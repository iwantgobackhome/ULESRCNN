...
net = module.Net(scale=4, 
                     group=1)
state_dict = torch.load("./checkpoint/lesrcnn_x4_477000.pth")
...
hr = Image.open("C:/Users/Home/Desktop/1024.png").convert("RGB")
...
im.show()
im.save("C:/Users/Home/Desktop/128to512_com.png")
