...
def parse_args():
    ...
    parser.add_argument("--ckpt_path", type=str, default="./checkpoint/lesrcnn_x2_567000.pth") # 이름 잘못 설정해줌, 나중에 재학습 시킬때 맞추기!
    parser.add_argument("--group", type=int, default=1)
    parser.add_argument("--sample_dir", type=str, default="samples_single_model_urban_x2")
